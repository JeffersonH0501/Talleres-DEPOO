...
public class ConsolaOlimpicos
{
	...
	{
		System.out.println("\n" + "Pais que representa un jugador" + "\n");
		String nombre = input("Ingrese el nombre del atleta que le interesa");
		String nombrepais = calculadora.bucarpaisdejugador(nombre);
		System.out.println("El pais al que representa el jugador es: " + nombrepais);
